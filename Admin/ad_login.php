            ...
            <div class="col-lg-6 m-auto">
                <div class="card mt-4">
                    <div class="card-header bg-warning">
                        <h5 class="card-title mb-0 text-white text-capitalize d-flex justify-content-between"> Admin Login Form 
                           <a href="ad_reg.php" class= "text-black"> Registration </a></h5>
                    </div>
                    <div class="card-body">
                    <?php
                    ...
                    ?>
                        <form action="ad_login_info.php" method="post">
